...
namespace InformationRetrievalManager.NLP.Test
{
    ...
    public class BasicProcessingTest : IDisposable
    {
        ...
        public void Index_CheckStopWords()
        {
            ...
            Assert.True(wordFrequencies.ContainsKey(_processing.GetProcessedForm("jestlie")));
            Assert.True(wordFrequencies.ContainsKey(_processing.GetProcessedForm("pøièem")));
        ...
        public void Index_CheckLongText()
        {
            ...
            var pText2 = _processing.GetProcessedForm("trby");
            if (wordFrequencies.ContainsKey(pText2))
